...
type AuthMethod =
  ...
  | { type: 'oauth2'; clientId: string; authEndpoint: string; tokenEndpoint: string; scopes: string[]; tokenRef: string; refreshTokenRef: string }
...
| InterfaceVersion → Plugin | *:* | Versions may depend on plugins |
